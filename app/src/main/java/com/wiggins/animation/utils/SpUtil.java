package com.wiggins.animation.utils;

import android.content.Context;
import android.content.SharedPreferences;
import android.content.SharedPreferences.Editor;

import com.wiggins.animation.app.MyApplication;
...
public class SpUtil {
    ...
    public static final String PATH = "/data/data/xxx/shared_prefs/shared_data.xml";
